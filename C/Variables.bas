...
Public IndexMoves(1 To 8, 1 To 10) As Long
...
Public ERR7 As Boolean
Public VP1Time As Time, VP2Time As Time, TotalTime As Time, VTurns As Long
...
Public MemoryLimit As Long
Public PruneThreshold As Long
